...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contactsRecyclerView = findViewById(R.id.homeRecyclerView)
    ...
    private fun initContactDialog(){
        ...
        val contactView = layoutInflater.inflate(R.layout.add_contact, null)
    ...
    private fun initDialogViews(contactView: View) {
        nameInputLayout = contactView.findViewById(R.id.nameInputAdd)
        nameEd = contactView.findViewById(R.id.nameEd)
        phoneInputLayout = contactView.findViewById(R.id.phoneInputAdd)
        phoneEd = contactView.findViewById(R.id.phoneEd)
        descriptionEd = contactView.findViewById(R.id.descriptionEd)
        addBtn = contactView.findViewById(R.id.addButton)
    }
